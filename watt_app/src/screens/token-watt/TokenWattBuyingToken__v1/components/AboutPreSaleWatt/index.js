          ...
          <View style={styles.content}>
            ...
            <View style={[styles.roundBlock, {backgroundColor: "#DDDDDD"}]}>
              <View style={styles.roundBlockHead}>
                ...
                <Text style={[styles.roundBlockAmount, {color: "#999999"}]}>132 000 WATT</Text>
              </View>
              <View style={styles.roundBlockBody}>
                <View style={styles.roundBlockPriceBlock}>
                  <Text style={[styles.roundBlockPriceLabel, {color: "#999999"}]}>Цена: <Text style={{fontWeight: "500"}}>$ 0.77</Text></Text>
                </View>
                <Text style={[styles.roundBlockDate, {color: "#999999"}]}>до 15 января 2022</Text>
              </View>
            </View>
