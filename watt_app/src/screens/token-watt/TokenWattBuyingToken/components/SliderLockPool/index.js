...
class SliderAmount extends React.PureComponent {
  ...
  render() {
    const {
      ...
      routeLockPoolInformation,
      routeLockPoolTransactions
    } = this.props;
      ...
      <View style={styles.root}>
        ...
        <View style={styles.footer}>
          <Button
            ...
            color="secondary"
            label={allTranslations(localization.tokenWattBuyingToken.sliderLockPool.information)}

            onPress={routeLockPoolInformation}
          />
          <Button
            style={styles.footerButton}
            labelStyle={styles.footerButtonLabel}
            color="secondary"
            label={allTranslations(localization.tokenWattBuyingToken.sliderLockPool.transactions)}

            onPress={routeLockPoolTransactions}
          />
        </View>
